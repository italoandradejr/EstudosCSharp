        ...
        case 3:
            {
                ...
                var contasPorAgengia = ConsultaPorAgencia(_numeroAgencia);
                ExibirListaDeContas(contasPorAgengia);
                Console.ReadKey();
                break;
            }
        default:
...
void ExibirListaDeContas(List<ContaCorrente> contasPorAgengia)
{
    if (contasPorAgengia == null)
    {
        Console.WriteLine("... A consulta não retornou dados...");
    }
    else
    {
        foreach (var item in contasPorAgengia)
        {
...
void ListarContas()
{
    ...
    {
        Console.WriteLine("...Näo há contas cadastradas...");
        Console.ReadKey();
        return;
    }
...
//teste1.MostraMensagem(10);

//Generica<string> teste2 = new Generica<string>();
//teste2.MostraMensagem("Olá mundo");
//public class Generica<T>
//{
//    public void MostraMensagem(T t)
//    {
...
//{
//    new ContaCorrente(95, "123456-A"),
//    new ContaCorrente(95, "951258-B"),
//    new ContaCorrente(94, "987321-C")
//};

//List<ContaCorrente> _listaDeContas3 = new List<ContaCorrente>()
//{
//    new ContaCorrente(95, "123456-D"),
//    new ContaCorrente(95, "951258-E"),
//    new ContaCorrente(94, "987321-F")
//};
